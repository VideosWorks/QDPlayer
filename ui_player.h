...
""));
        ...
        video_grid_layout->addLayout(horizontalLayout_5, 1, 3, 1, 1);
        ...
        video_grid_layout->addLayout(renderer_layout, 0, 3, 1, 1);

        gridLayout_4 = new QGridLayout();
        gridLayout_4->setSpacing(12);
        gridLayout_4->setObjectName(QStringLiteral("gridLayout_4"));
        gridLayout_4->setContentsMargins(-1, 12, 12, 12);

        video_grid_layout->addLayout(gridLayout_4, 0, 2, 1, 1);

        horizontalSpacer_3 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        video_grid_layout->addItem(horizontalSpacer_3, 0, 1, 1, 1);

        horizontalSpacer_4 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        video_grid_layout->addItem(horizontalSpacer_4, 0, 4, 1, 1);

        horizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        video_grid_layout->addItem(horizontalSpacer, 0, 0, 1, 1);
        ...
        calendar->setMinimumSize(QSize(200, 0));
        calendar->setMaximumSize(QSize(500, 16777215));
