    ...
    ui(new Ui::Player)
{
    ...
    m_player->play("C:/Users/sw_arge/Desktop/video/00000005.bkt");
}
...
void Player::read_RdbFile(QString file_path,QDate date)
{
    ...
    for(int i=0;i<MAX_CHANNEL;i++)
    {
        ...
        qDebug()<<"------------------------------------------------------------------"   + QString::number(i+1)   + "                                          bitti -------        ----------------------------------";
    }
...
void Player::read_Index_File(QString file_path)
{
    qDebug()<< "\n\n\n---Start read index file--- ";
    FILE *idx;
    QString filename = "C:/Users/sw_arge/Desktop/video/00000005.idx";
    char* cstr;
    ...
    else
    {
        ...
        {
            qDebug()<<"\n\n succes read   index header file              ihd bid :   "<< ihd.bid << "        ihd   count : "<< ihd.count;
            int index_count=0;
            T_INDEX_DATA idd;
            ...
            qDebug() << " index header  id : " <<QString::number(ihd.id,16)<< "index header bid : "<< ihd.bid  <<  " index header  count : "<< ihd.count ;
            qDebug()<< "\n\n\n ---- index    header   finished ----";
