...
void Player::resizeEvent(QResizeEvent* event)
{
  ...
  //  m_renderer1->widget()->setMinimumHeight(m_renderer1->videoRect().height());
  //  m_renderer1->widget()->setMaximumHeight(m_renderer1->videoRect().height());
  //  m_renderer1->widget()->setMinimumWidth(m_renderer1->videoRect().width());
  //  m_renderer1->widget()->setMaximumWidth(m_renderer1->videoRect().width());

  //  m_renderer2->widget()->setMinimumHeight(m_renderer2->videoRect().height());
  //  m_renderer2->widget()->setMaximumHeight(m_renderer2->videoRect().height());
  //  m_renderer2->widget()->setMinimumWidth(m_renderer2->videoRect().width());
  //  m_renderer2->widget()->setMaximumWidth(m_renderer2->videoRect().width());

  //  m_renderer3->widget()->setMinimumHeight(m_renderer3->videoRect().height());
  //  m_renderer3->widget()->setMaximumHeight(m_renderer3->videoRect().height());
  //  m_renderer3->widget()->setMinimumWidth(m_renderer3->videoRect().width());
  //  m_renderer3->widget()->setMaximumWidth(m_renderer3->videoRect().width());

  //  m_renderer4->widget()->setMinimumHeight(m_renderer4->videoRect().height());
  //  m_renderer4->widget()->setMaximumHeight(m_renderer4->videoRect().height());
  //  m_renderer4->widget()->setMinimumWidth(m_renderer4->videoRect().width());
  //  m_renderer4->widget()->setMaximumWidth(m_renderer4->videoRect().width());
  //if(m_player->isPlaying())
  //  {
  //    m_renderer1->resizeRenderer(m_renderer1->widget()->width(),m_renderer1->widget()->height());
  //    m_renderer2->resizeRenderer(m_renderer2->widget()->width(),m_renderer2->widget()->height());
  //    m_renderer3->resizeRenderer(m_renderer3->widget()->width(),m_renderer3->widget()->height());
  //    m_renderer4->resizeRenderer(m_renderer4->widget()->width(),m_renderer4->widget()->height());



  //    m_renderer1->videoRect().setWidth(m_renderer1->widget()->width());
  //    m_renderer2->videoRect().setWidth(m_renderer2->widget()->width());
  //    m_renderer3->videoRect().setWidth(m_renderer3->widget()->width());
  //    m_renderer4->videoRect().setWidth(m_renderer4->widget()->width());
  ...
  //  m_renderer1->widget()->resize(m_renderer1->videoFrameSize().width(),m_renderer1->videoFrameSize().height());
  //  m_renderer2->widget()->resize(m_renderer2->videoFrameSize().width(),m_renderer2->videoFrameSize().height());
  //  m_renderer3->widget()->resize(m_renderer3->videoFrameSize().width(),m_renderer3->videoFrameSize().height());
  //  m_renderer4->widget()->resize(m_renderer4->videoFrameSize().width(),m_renderer4->videoFrameSize().height());
...
void Player::mousePressEvent(QMouseEvent *event)
{
  ...
  if(widget)
    {
      const int index = ui->renderer_layout->layout()->indexOf(widget);
      a=index;
...
void Player::on_two_screen_btn_clicked()
{
  clicked_state=1;
  m_renderer1->widget()->setVisible(false);
  m_renderer2->widget()->setVisible(false);
...
{
  //   ui->renderer_layout->removeWidget(m_renderer1->widget());
  //   ui->renderer_layout->removeWidget(m_renderer2->widget());
  //   ui->renderer_layout->removeWidget(m_renderer3->widget());
  //   ui->renderer_layout->removeWidget(m_renderer4->widget());
  //    if(full_screen_state==0)
  //      {
  //         this->close();
  //        QWidget *w = new  QWidget ;
  //        QGridLayout *layout =new  QGridLayout;
  //        layout->addWidget(m_renderer1->widget(),0,0);
  //        w->setLayout(layout);
  ...
  if (maxMode== false)
    {
     // this->hide();
      m_enOrigWindowFlags = m_renderer1->widget()->windowFlags();
      m_pSize = m_renderer1->widget()->size();
      m_renderer1->widget()->setParent(NULL);
      m_renderer1->widget()->setWindowFlags( Qt::FramelessWindowHint|Qt::WindowStaysOnTopHint);
      m_renderer1->widget()->showMaximized();
      maxMode = true;
    }
  else
    {
      m_renderer1->widget()->setParent(this);
      ui->renderer_layout->addWidget(m_renderer1->widget(),0,0);
//      m_renderer1->widget() ->resize(m_pSize);
//      m_renderer1->widget()->overrideWindowFlags(m_enOrigWindowFlags);
     // m_renderer1->widget()->show();
      this->show();
      maxMode =  false;
    }
